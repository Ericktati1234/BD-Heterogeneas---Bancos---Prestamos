Public Class FormSucursalesB

    Sub reiniciar()
        LlenaGrid(sqlConexion, dgvSucursales, "use BDHeterogenea exec sp_SeleccionarSucursalPorRegion 2")
        txtActivos.Text = ""
        txtCiudad.Text = ""
        txtNombre.Text = ""
        txtRegion.Text = ""
    ...
    Private Sub FormSucursalesB_Load(sender As Object, e As EventArgs) Handles Me.Load
        reiniciar()
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Else
            If MessageBox.Show("Quieres guardar los cambios?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                ...
                sqlcmdComando.CommandText = "USE BDHeterogenea_RegionB INSERT INTO Sucursal VALUES ('" & txtNombre.Text & "','" & txtCiudad.Text & "'," & txtActivos.Text & ",'B');"
