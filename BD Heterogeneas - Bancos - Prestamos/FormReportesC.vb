...
Public Class FormReportesC
    ...
    Private Sub btnPrestamos_Click(sender As Object, e As EventArgs) Handles btnPrestamos.Click
        LlenaGrid(sqlConexion, dgvReportes, "use BDHeterogenea exec sp_SeleccionarPrestamoPorRegion 3")
    ...
    Private Sub btnSucursales_Click(sender As Object, e As EventArgs) Handles btnSucursales.Click
        LlenaGrid(sqlConexion, dgvReportes, "use BDHeterogenea exec sp_SeleccionarSucursalPorRegion 3")
